...
help_msg:
    ...
    db "AOS tools: lspci driver/drivers net route neigh dhcp tcp httpget kshttpget wget download gethost wifi fw usb ping ping6 rdisc6 dns nslookup netrawtest mem uptime date uname whoami id sudo aossetup settings display gfxdemo inputtest mounts partitions nano aosnano touch rm mkdir rmdir shutdown restart reboot", 10
