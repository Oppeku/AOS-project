...
$(BUILD_DIR)/initrd.img: hello.txt pakages/pakages.txt firmware/aos-wifi-placeholder.fw firmware/iwlwifi-test.fw $(BUILD_DIR)/user.elf $(BUILD_DIR)/user2.elf $(BUILD_DIR)/shell.elf $(BUILD_DIR)/filetest.elf $(BUILD_DIR)/accesstest.elf $(BUILD_DIR)/openflagstest.elf $(BUILD_DIR)/duptest.elf $(BUILD_DIR)/pipetest.elf $(BUILD_DIR)/wait4test.elf $(BUILD_DIR)/stdincat.elf $(BUILD_DIR)/argvtest.elf $(BUILD_DIR)/pathtest.elf $(BUILD_DIR)/partitions.elf $(BUILD_DIR)/mounts.elf $(BUILD_DIR)/lspci.elf $(BUILD_DIR)/drivers.elf $(BUILD_DIR)/net.elf $(BUILD_DIR)/ip.elf $(BUILD_DIR)/wifi.elf $(BUILD_DIR)/firmware.elf $(BUILD_DIR)/usb.elf $(BUILD_DIR)/ping.elf $(BUILD_DIR)/ping6.elf $(BUILD_DIR)/rdisc6.elf $(BUILD_DIR)/route.elf $(BUILD_DIR)/neigh.elf $(BUILD_DIR)/dhcp.elf $(BUILD_DIR)/tcp.elf $(BUILD_DIR)/curl.elf $(BUILD_DIR)/acur.elf $(BUILD_DIR)/afetch.elf $(BUILD_DIR)/kshttpget.elf $(BUILD_DIR)/tcpstress.elf $(BUILD_DIR)/dlstress.elf $(BUILD_DIR)/wget.elf $(BUILD_DIR)/https.elf $(BUILD_DIR)/sockclose.elf $(BUILD_DIR)/gethost.elf $(BUILD_DIR)/netcache.elf $(BUILD_DIR)/netstat.elf $(BUILD_DIR)/netrawtest.elf $(BUILD_DIR)/mem.elf $(BUILD_DIR)/uptime.elf $(BUILD_DIR)/uname.elf $(BUILD_DIR)/whoami.elf $(BUILD_DIR)/id.elf $(BUILD_DIR)/ps.elf $(BUILD_DIR)/aossetup.elf $(BUILD_DIR)/display.elf $(BUILD_DIR)/settings.elf $(BUILD_DIR)/vsys.elf $(BUILD_DIR)/shutdown.elf $(BUILD_DIR)/restart.elf $(BUILD_DIR)/date.elf $(BUILD_DIR)/touch.elf $(BUILD_DIR)/rm.elf $(BUILD_DIR)/mkdir.elf $(BUILD_DIR)/sudo.elf $(BUILD_DIR)/devtest.elf $(BUILD_DIR)/gfxdemo.elf $(BUILD_DIR)/inputtest.elf $(BUILD_DIR)/nano.elf $(BUILD_DIR)/gnu-nano $(BUILD_DIR)/busybox $(BUILD_DIR)/coreutils $(BUILD_DIR)/gnu-coreutils.stamp
...
$(BUILD_DIR)/ps.elf: $(BUILD_DIR)/ps.o userspace/user.ld
	$(LD) -nostdlib -pie -T userspace/user.ld -o $@ $(BUILD_DIR)/ps.o
